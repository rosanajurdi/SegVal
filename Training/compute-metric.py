'''
@author: eljurros
the script takes as input the paths of both gt_npy and prediction_npy slices in 2D and 
generates two cvs files with regards to the 3D evaluation of segmentation to haussdorf and dice. 
'''
import pandas as pd
...
prediction_dir = '/Validation_Project/BrainTumor/Task01_BrainTumour/fold_2/results_500_/Patient_RESULTS/predictions_img'
gt_dir = 'Validation_Project/BrainTumor/Task01_BrainTumour/fold_2/results_500_/Patient_RESULTS/gt_npy'
...
fold_all_H1 = open('/SegVal_Project/results-dice.csv', "w")
fold_all_H1.write(f"file, metric \n")

fold_all_H2 = open('/SegVal_Project/results-hauss.csv', "w")
