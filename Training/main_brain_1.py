...
def get_args() -> argparse.Namespace:
    ...
    parser.add_argument('--dataset', type=str, default='/network/lustre/iss02/aramis/users/rosana.eljurdi/Validation_Project/BrainTumor/fold_1/npy')
    parser.add_argument("--csv", type=str, default= 'metrics.csv')
    parser.add_argument("--workdir", type=str, default = '/network/lustre/iss02/aramis/users/rosana.eljurdi/Validation_Project/BrainTumor/fold_1/results_500_3')
    parser.add_argument('--batch_size', type=int, default=8)
    parser.add_argument("--cpu", action='store_true', default = False)
    parser.add_argument("--debug", action="store_true", default = False)
    parser.add_argument("--modalities", type=int, default=4)
    parser.add_argument("--weights", type=str, default='/network/lustre/iss02/aramis/users/rosana.eljurdi/Validation_Project/BrainTumor/fold_1/results_500_2/best2-f2.pkl', help="Stored weights to restore")
    ...
    parser.add_argument("--metric_axis", type=int, nargs='+', help="Classes to display metrics", default=[1,2, 3])
    ...
    parser.add_argument("--losses", type=str, 
                        ...
                        default="[('GeneralizedDice', {'idc': [0, 1, 2,3]}, None, None, None, 1)]")
