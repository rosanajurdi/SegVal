...
for _, _, files in os.walk(os.path.join('/Users/rosana.eljurdi/Documents/Confidence_Intervals_Olivier/Task01_BrainTumour/Splits/test_npy/test_npy', 'in_npy')):

    print('walking into', os.path.join(root, 'in_npy'))
    for file in files:
        if 'BRATS_400' in file:
            print(file)
