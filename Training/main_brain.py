...
def get_args() -> argparse.Namespace:
    ...
    parser.add_argument("--workdir", type=str, default = '/network/lustre/iss02/aramis/users/rosana.eljurdi/Validation_Project/BrainTumor/Task01_BrainTumour/fold_3/results_NEW')
