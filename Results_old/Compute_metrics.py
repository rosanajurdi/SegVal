...
prediction_dir = '/Results_old/Hippo/predictions_npy'
gt_dir = '/Users/rosana.eljurdi/Documents/Confidence_Intervals_Olivier/Task04_Hippocampus/Splits/test/test_npy/gt_npy'


#3D result file setup: redo results for val reran the project wrongly.
fold_all_H1 = open('/Results_old/Hippo/results-dice.csv', "w")
fold_all_H1.write(f"file, metric \n")

fold_all_H2 = open('/Results_old/Hippo/results-hauss.csv', "w")
